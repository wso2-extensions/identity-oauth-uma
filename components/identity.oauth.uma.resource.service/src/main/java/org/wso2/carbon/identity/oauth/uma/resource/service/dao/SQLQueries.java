...
public class SQLQueries {
    ...
    public static final String GET_ALL_RESOURCES = "SELECT RESOURCE_ID FROM IDN_RESOURCE WHERE RESOUCE_OWNER_ID = ?";
    ...
    public static final String UPDATE_SCOPE = "UPDATE IDN_RESOURCE_SCOPE SET SCOPE_NAME = ? WHERE IDN_RESOURCE_SCOPE" +
            ".FK_RESOURCE_ID = (SELECT ID FROM IDN_RESOURCE WHERE RESOURCE_ID = ?);";

    public static final String GET_SCOPES = "SELECT * FROM IDN_RESOURCE_SCOPE WHERE FK_RESOURCE_ID = " +
            "(SELECT ID FROM IDN_RESOURCE WHERE RESOURCE_ID = ?)";
