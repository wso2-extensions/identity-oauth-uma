...
public class ResourceUtilsTest {
    ...
    /*  Resource resource = ResourceUtils.getResource(resourceDetailsDTO);
      assertNotEquals(resource.getScopes(), null, "Actual scopes are not " +
              "match for expected scopes");
      assertNotNull(resourceDetailsDTO, null, "Actual IconUri  match " +
              "for expected IconUri");
      assertEquals(resource.getType(), null, "Actual type  match for expected type");
      assertEquals(resource.getDescription(), null, "Actual description" +
              " match for expected " +
              "description");
      assertEquals(resource.getName(), null, "Actual name  match for expected name");
  }*/
    @Test
