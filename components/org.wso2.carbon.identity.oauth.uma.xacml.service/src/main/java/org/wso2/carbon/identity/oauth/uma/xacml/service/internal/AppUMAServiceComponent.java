...
/**
 *  Service component for UMA Component.
 */

@Component(
        name = "org.wso2.carbon.identity.uma.XACML.internal.AppUMAServiceComponent",
        immediate = true
)
public class AppUMAServiceComponent {

    private static final Log log = LogFactory.getLog(AppUMAServiceComponent.class);
    ...
    protected void setEntitlementService(EntitlementService entitlementService) {
        ...
        AppUMADataholder.getInstance().setEntitlementService(entitlementService);
    }
    ...
    protected void unsetEntitlementService(EntitlementService entitlementService) {
        ...
        AppUMADataholder.getInstance().setEntitlementService(null);
    }
}
