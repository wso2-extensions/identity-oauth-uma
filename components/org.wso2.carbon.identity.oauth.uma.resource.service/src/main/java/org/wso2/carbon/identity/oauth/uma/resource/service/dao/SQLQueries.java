...
public class SQLQueries {
    ...
    public static final String STORE_RESOURCE = "INSERT INTO IDN_RESOURCE (RESOURCE_ID, RESOURCE_NAME, TIME_CREATED," +
            "RESOURCE_OWNER_NAME, CLIENT_ID, TENANT_ID, USER_DOMAIN) VALUES (:"
    ...
    public static final String STORE_RESOURCE_META_DETAILS = "INSERT INTO IDN_RESOURCE_META_DATA (" +
    ...
    public static final String STORE_RESOURCE_SCOPES = "INSERT INTO IDN_RESOURCE_SCOPE (RESOURCE_IDENTITY, " +
            "SCOPE_NAME) VALUES (:" + UMAConstants.SQLPlaceholders.ID + ";,:" + UMAConstants.SQLPlaceholders.SCOPE_NAME
            + ";)";

    public static final String GET_RESOURCE_NAME = "SELECT RESOURCE_NAME FROM IDN_RESOURCE WHERE RESOURCE_ID = :" +
    ...
    public static final String GET_RESOURCE_META_DATA = "SELECT PROPERTY_KEY, PROPERTY_VALUE FROM " +
            "IDN_RESOURCE_META_DATA WHERE RESOURCE_IDENTITY = :" + UMAConstants.SQLPlaceholders.ID + ";";

    public static final String GET_RESOURCE_SCOPES = "SELECT SCOPE_NAME FROM IDN_RESOURCE_SCOPE WHERE " +
            "RESOURCE_IDENTITY = :" + UMAConstants.SQLPlaceholders.ID + ";";

    public static final String DELETE_RESOURCE = "DELETE FROM IDN_RESOURCE WHERE ID = :"
    ...
    public static final String GET_ALL_RESOURCES = "SELECT RESOURCE_ID FROM IDN_RESOURCE WHERE RESOURCE_OWNER_NAME = :"
            + UMAConstants.SQLPlaceholders.RESOURCE_OWNER_NAME + "; AND USER_DOMAIN = :" +
            UMAConstants.SQLPlaceholders.USER_DOMAIN + "; AND CLIENT_ID = :" + UMAConstants.SQLPlaceholders.CLIENT_ID
            + ";";

    public static final String UPDATE_RESOURCE = "UPDATE IDN_RESOURCE SET RESOURCE_NAME = :"
            + UMAConstants.SQLPlaceholders.RESOURCE_NAME + "; WHERE ID = :"
            + UMAConstants.SQLPlaceholders.ID + ";";

    public static final String DELETE_RESOURCE_SCOPES = "DELETE FROM IDN_RESOURCE_SCOPE WHERE RESOURCE_IDENTITY = :"
            + UMAConstants.SQLPlaceholders.ID + ";";

    public static final String CHECK_RESOURCE_NAME_EXISTENCE = "SELECT RESOURCE_NAME FROM IDN_RESOURCE WHERE " +
    ...
    public static final String CHECK_RESOURCE_ID_EXISTENCE = "SELECT ID FROM IDN_RESOURCE WHERE RESOURCE_ID = :"
            + UMAConstants.SQLPlaceholders.RESOURCE_ID + ";";
