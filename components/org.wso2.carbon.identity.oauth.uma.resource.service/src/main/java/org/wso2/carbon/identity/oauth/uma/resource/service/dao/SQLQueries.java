...
public class SQLQueries {
    ...
    public static final String DELETESCOPES = "DELETE FROM IDN_RESOURCE_SCOPE WHERE RESOURCE_IDENTITY " +
            "=(SELECT ID FROM IDN_RESOURCE WHERE RESOURCE_ID = ?);";

    public static final String UPDATESCOPES = "INSERT INTO IDN_RESOURCE_SCOPE(RESOURCE_IDENTITY,SCOPE_NAME) " +
